...
return (
        <div className={`flex flex-col ${props.isSlider ? 'w-[100%]' : 'lg:w-[31%] md:w-[48%] w-[100%]'} shadow-lg rounded-2xl overflow-hidden md:mb-10 mb-2 hover:transform hover:translate-y-[-10px] hover:transition-transform `}>
