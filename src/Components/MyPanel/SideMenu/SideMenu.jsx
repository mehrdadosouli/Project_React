...
function SideMenu() {
  ...
  return (
      <div className='sm:relative absolute sm:w-[25%] w-[35%] p-5 flex flex-col z-40'>
          ...
          <div className={`py-16 flex flex-col gap-10 sm:visible translate-x-[15rem] sm:bg-inherit bg-slate-500 text-center sm:transform-none transform transition-all ease-linear ${showMenu ? 'visible translate-x-[0rem]' : 'invisible'}`}>
