...
const initialState={
    menu:[
        ...
        {id:3,page:'فرانت اند',link:'/frontend',icon:'',submenu:[
            {id:1,page:'آموزش جاوااسکریپت',icon:'',link:'/courses?name=js-expert'},
            {id:2,page:'آموزش 20 کتابخانه جاوا اسکریپت',icon:'',link:'/courses?name=js-20-lib'},
            {id:3,page:'دوره پروژه محور بوت استرپ',icon:'',link:'/courses?name=bootstrap'},
            {id:4,page:'دوره جامع Css',icon:'',link:'/courses?name=css-course'},
            {id:5,page:'دوره جامع Html',icon:'',link:'/courses?name=html'},
            {id:6,page:'دوره آموزش Vuejs',icon:'',link:'/courses?name=vuejs'},
